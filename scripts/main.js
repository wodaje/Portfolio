const links = ["https://www.linkedin.com/in/jeff-woda-1033933/","./assets/Woda_CV_Main.pdf","https://github.com/wodaje", "lottoNum()"]

let refEl = ('<a onClick="miX();return false;" href="#">PLAY ***PowerBall Numbers*** PLAY </a>')
...
function lottoNum(){        
        ...
        for (c = 2; c < 6; c = c){     
            ...
            if (num1 === num2 || num1 === num3 || num1 === num4 || num1 === num5 || num2 === num3 || num2 === num4 || num2 === num5 || num3 === num4 || num3 === num5 || num4 === num5){
                console.log("dupe caught " + num1 +" "+ num2 + " " + num3 + " " + num4 + " " + num5)
